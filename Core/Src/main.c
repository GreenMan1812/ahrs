...
int main(void) {
  ...
  MX_GPIO_Init();
  /* USER CODE BEGIN 2 */
  icm20948Config.timPre = SystemCoreClock / 20000UL - 1;
  icm20948Config.timArr = 24;
  icm20948Config.gyro_conf = 0;
  icm20948Config.accel_conf = 0;
  icm20948Config.prescaler = 5;
  icm20948Config.prescalerCount = 0;
  icm20948Config.changeStatus = 0;
...
void MPU_Config(void) {
   ...
   */
  LL_MPU_ConfigRegion(
      LL_MPU_REGION_NUMBER0, 0x87, 0x0,
